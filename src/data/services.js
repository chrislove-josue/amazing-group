...
export const SERVICES = [
  ...
  },
  {
    ...
    icon: Megaphone,
    desc: "Transformez votre marque en expérience mémorable grâce à nos campagnes créatives et impactantes, en ligne et sur le terrain.",
    bullets: ["Création d'identité visuelle percutante", "Supports imprimés & signalétique grand format", "Campagnes 360° intégrées et engageantes"],
  },
  {
    title: "Commerce Général",
    icon: ShoppingBag,
    desc: "Optimisez votre chaîne d’approvisionnement et votre distribution grâce à notre expertise multi-secteurs, fiable et agile.",
    bullets: ["Sourcing international stratégique", "Distribution locale efficace et rapide", "Logistique et stockage sécurisés"],
  },
  {
    title: "Transport",
    icon: Truck,
